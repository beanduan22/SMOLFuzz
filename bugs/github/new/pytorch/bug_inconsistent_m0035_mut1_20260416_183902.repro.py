...
APIs    : torch.nn.init.kaiming_normal_, torch.nn.functional.glu, torch.unique_consecutive, torch.Tensor.tensor_split, float_power_, torch.erf, torch.Tensor.sort, torch.abs, torch.log1p, torch.asinh

Run:  python3 bug_inconsistent_m0035_mut1_20260416_183902.repro.py
...
inputs = torch.load(_here / 'bug_inconsistent_m0035_mut1_20260416_183902.inputs.pt', weights_only=False)
