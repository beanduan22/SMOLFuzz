...
APIs    : torch.nn.Linear, torch.maximum, torch.sin, torch.cos, torch.sub, torch.bmm, torch.enable_grad

Run:  python3 bug_inconsistent_m0404_mut5_20260410_034302.repro.py
...
inputs = torch.load(_here / 'bug_inconsistent_m0404_mut5_20260410_034302.inputs.pt', weights_only=False)
