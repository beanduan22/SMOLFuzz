...
APIs    : torch.nn.Linear, torch.nn.BatchNorm1d, torch.nn.functional.dropout, torch.arctan, torch.matrix_exp, torch.Tensor.greater_equal

Run:  python3 bug_inconsistent_m0467_mut5_20260410_050538.repro.py
...
inputs = torch.load(_here / 'bug_inconsistent_m0467_mut5_20260410_050538.inputs.pt', weights_only=False)
