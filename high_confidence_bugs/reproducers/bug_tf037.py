...
L2      : l2=1.6496e-03 > threshold=1e-03 finite_elements=16
APIs    : tf.keras.layers.SeparableConvolution2D, tf.keras.metrics.SquaredHinge, tf.nn.max_pool1d, tf.keras.activations.elu

Run: python3 bug_tf037.py
