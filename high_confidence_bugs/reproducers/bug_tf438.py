...
L2      : l2=2.5672e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.experimental.numpy.shape, tf.keras.activations.hard_sigmoid, tf.keras.regularizers.deserialize, tf.tan

Run: python3 bug_tf438.py
