...
L2      : l2=2.7108e-03 > threshold=1e-03 finite_elements=32
APIs    : tf.keras.activations.relu, tf.keras.initializers.GlorotUniform, tf.keras.optimizers.deserialize, tf.math.not_equal

Run: python3 bug_tf481.py
