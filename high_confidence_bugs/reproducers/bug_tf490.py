...
L2      : l2=1.2183e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.math.top_k, tf.keras.regularizers.l2, tf.keras.layers.Conv2D, tf.keras.initializers.LecunNormal

Run: python3 bug_tf490.py
