...
L2      : l2=1.1008e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.keras.layers.RandomContrast, tf.keras.losses.mean_absolute_percentage_error, tf.experimental.numpy.repeat, tf.nn.conv1d_transpose

Run: python3 bug_tf147.py
