...
L2      : l2=1.1206e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.nn.max_pool2d, tf.keras.applications.VGG19, tf.keras.layers.experimental.preprocessing.RandomFlip, tf.math.segment_mean

Run: python3 bug_tf208.py
