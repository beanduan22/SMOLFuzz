...
L2      : l2=1.5403e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.experimental.numpy.triu, tf.keras.utils.unpack_x_y_sample_weight, tf.keras.activations.swish, tf.keras.applications.Xception

Run: python3 bug_tf355.py
