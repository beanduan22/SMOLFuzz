...
L2      : l2=1.4475e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.initializers.LecunUniform, tf.nn.elu, tf.keras.layers.MaxPool2D, tf.keras.experimental.SequenceFeatures

Run: python3 bug_tf040.py
