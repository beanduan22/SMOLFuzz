...
L2      : l2=9.8606e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.keras.utils.custom_object_scope, tf.math.tanh, tf.keras.layers.ZeroPadding3D, tf.keras.layers.Lambda

Run: python3 bug_tf266.py
