...
L2      : l2=1.2178e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.applications.densenet.decode_predictions, tf.keras.layers.experimental.preprocessing.RandomZoom, tf.experimental.numpy.concatenate, tf.keras.layers.Cropping2D

Run: python3 bug_tf479.py
