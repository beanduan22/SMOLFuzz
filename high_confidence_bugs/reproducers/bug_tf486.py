...
L2      : l2=1.8473e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.math.unsorted_segment_max, tf.math.scalar_mul, tf.keras.layers.Conv1D, tf.experimental.numpy.broadcast_arrays

Run: python3 bug_tf486.py
