...
L2      : l2=1.0939e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.keras.applications.inception_resnet_v2.preprocess_input, tf.keras.losses.Loss, tf.keras.losses.kld, tf.nn.ctc_beam_search_decoder

Run: python3 bug_tf452.py
