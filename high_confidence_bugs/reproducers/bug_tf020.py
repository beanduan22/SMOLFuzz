...
L2      : l2=9.7942e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.keras.activations.selu, tf.keras.layers.Normalization, tf.math.sinh, tf.sin

Run: python3 bug_tf020.py
