...
L2      : l2=1.0375e-03 > threshold=1e-03 finite_elements=2
APIs    : tf.keras.applications.densenet.preprocess_input, tf.experimental.numpy.atleast_2d, tf.atanh, tf.experimental.numpy.minimum

Run: python3 bug_tf053.py
