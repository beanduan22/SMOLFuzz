...
L2      : l2=3.9444e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.keras.layers.SpatialDropout3D, tf.keras.losses.sparse_categorical_crossentropy, tf.keras.layers.subtract, tf.keras.layers.experimental.preprocessing.RandomRotation

Run: python3 bug_tf261.py
