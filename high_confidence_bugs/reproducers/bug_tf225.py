...
L2      : l2=1.2240e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.layers.Cropping3D, tf.keras.layers.CategoryEncoding, tf.experimental.numpy.tril, tf.experimental.numpy.ndim

Run: python3 bug_tf225.py
