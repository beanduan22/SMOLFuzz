...
L2      : l2=6.3993e+00 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.metrics.Recall, tf.experimental.dlpack.to_dlpack, tf.keras.utils.SequenceEnqueuer, tf.keras.layers.TimeDistributed

Run: python3 bug_tf025.py
