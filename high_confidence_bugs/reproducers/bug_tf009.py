...
L2      : l2=2.8414e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.nn.conv_transpose, tf.experimental.numpy.int_, tf.keras.losses.squared_hinge, tf.keras.layers.Lambda

Run: python3 bug_tf009.py
