...
L2      : l2=9.0370e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.keras.layers.MaxPooling3D, tf.experimental.numpy.uint32, tf.keras.callbacks.ModelCheckpoint, tf.keras.applications.efficientnet.EfficientNetB1

Run: python3 bug_tf482.py
