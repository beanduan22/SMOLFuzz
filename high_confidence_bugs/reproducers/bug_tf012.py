...
L2      : l2=9.6220e+00 > threshold=1e-03 finite_elements=1
APIs    : tf.experimental.numpy.dstack, tf.keras.losses.MeanAbsolutePercentageError, tf.keras.utils.serialize_keras_object, tf.math.tanh

Run: python3 bug_tf012.py
