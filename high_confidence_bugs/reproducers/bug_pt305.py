...
Detail  : output[0]: l2=2.7761e-01 > threshold=1e-03 finite_elements=32 shape=[4, 8]
APIs    : torch.nn.Linear, torch.nn.BatchNorm1d, torch.sin, torch.nn.Dropout, torch.special.i1
Mutation: scale_small

Run: python3 bug_pt305.py
...
def run():
    ...
    inp0 = torch.tensor([[-0.02284027449786663, -0.07395080476999283, 0.03191496059298515, -0.007120714522898197, 0.05771797150373459, 0.02896593138575554, 0.08116773515939713, 0.011218881234526634], [-0.05122086778283119, -0.025138014927506447, 0.005301703233271837, -0.003423071466386318, 0.04808395355939865, -0.044516053050756454, -0.05877796933054924, 0.053614791482686996], [0.010493193753063679, -0.07350431382656097, 0.07965295016765594, -0.18556658923625946, 0.07858848571777344, 0.038154978305101395, -0.017404858022928238, -0.03155389428138733], [-0.011617076583206654, 0.016158800572156906, 0.004799781367182732, -0.054735757410526276, -0.06304682791233063, -0.016831982880830765, 0.006482676137238741, -0.06041552871465683]], dtype=torch.float32)
    inputs = [inp0]
