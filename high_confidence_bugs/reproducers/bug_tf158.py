...
L2      : l2=1.1558e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.keras.layers.GlobalAveragePooling1D, tf.experimental.numpy.string_, tf.sign, tf.math.special.bessel_j1

Run: python3 bug_tf158.py
