...
L2      : l2=2.3879e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.nn.nce_loss, tf.keras.initializers.TruncatedNormal, tf.signal.mdct, tf.keras.metrics.mean_squared_error

Run: python3 bug_tf478.py
