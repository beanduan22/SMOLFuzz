...
L2      : l2=1.5950e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.applications.resnet50.ResNet50, tf.keras.metrics.PrecisionAtRecall, tf.experimental.numpy.concatenate, tf.pow

Run: python3 bug_tf381.py
