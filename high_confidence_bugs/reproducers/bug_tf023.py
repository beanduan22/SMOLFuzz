...
L2      : l2=1.0952e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.metrics.mean_squared_logarithmic_error, tf.linalg.set_diag, tf.keras.utils.custom_object_scope, tf.keras.layers.GlobalAveragePooling1D

Run: python3 bug_tf023.py
