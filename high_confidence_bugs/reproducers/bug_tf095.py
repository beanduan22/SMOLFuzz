...
L2      : l2=1.0915e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.layers.ELU, tf.nn.avg_pool2d, tf.experimental.numpy.complex128, tf.experimental.numpy.tri

Run: python3 bug_tf095.py
