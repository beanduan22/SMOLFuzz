...
L2      : l2=3.1901e-03 > threshold=1e-03 finite_elements=16
APIs    : tf.keras.preprocessing.sequence.pad_sequences, tf.keras.layers.Flatten, tf.keras.callbacks.LambdaCallback, tf.keras.initializers.he_uniform

Run: python3 bug_tf029.py
