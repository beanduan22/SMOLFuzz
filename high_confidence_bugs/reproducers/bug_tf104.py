...
L2      : l2=1.1591e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.callbacks.EarlyStopping, tf.keras.constraints.MinMaxNorm, tf.experimental.numpy.hypot, tf.keras.initializers.lecun_uniform

Run: python3 bug_tf104.py
