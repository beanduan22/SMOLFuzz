...
L2      : l2=2.3589e-03 > threshold=1e-03 finite_elements=4
APIs    : tf.keras.constraints.max_norm, tf.keras.metrics.poisson, tf.experimental.numpy.arcsinh, tf.experimental.numpy.fabs

Run: python3 bug_tf246.py
