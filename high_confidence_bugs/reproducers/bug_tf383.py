...
L2      : l2=2.2796e-03 > threshold=1e-03 finite_elements=2
APIs    : tf.math.special.fresnel_cos, tf.keras.applications.ResNet50V2, tf.keras.utils.SequenceEnqueuer, tf.keras.layers.Conv3DTranspose

Run: python3 bug_tf383.py
