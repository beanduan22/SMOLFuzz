...
L2      : l2=1.6901e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.keras.applications.DenseNet169, tf.signal.ifft, tf.experimental.dispatch_for_unary_elementwise_apis, tf.experimental.numpy.max

Run: python3 bug_tf202.py
