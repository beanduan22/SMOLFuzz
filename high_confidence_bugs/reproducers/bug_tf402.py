...
L2      : l2=2.5063e-03 > threshold=1e-03 finite_elements=1
APIs    : tf.experimental.numpy.sum, tf.linalg.einsum, tf.keras.constraints.NonNeg, tf.experimental.numpy.exp

Run: python3 bug_tf402.py
